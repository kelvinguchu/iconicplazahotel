        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {facilities.map((facility, index) => (
              <div
                key={index}
                className="bg-card border border-foreground/10 p-8 text-center group hover:border-foreground/20 transition-colors duration-300 rounded-lg lg:rounded-none"
              >
                {/* Icon */}
      ...
      <section className="bg-background">
        <div className="grid lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center p-8 lg:p-16">
            ...
            <h2
              className="font-heading text-3xl lg:text-4xl font-normal text-foreground mb-8"
              style={{ fontFamily: "'Playfair Display', serif" }}
            >
              Extra Services
            </h2>
            ...
            <div className="space-y-0">
              {extraServices.map((service, index) => (
                <div
                  key={index}
                  className="flex justify-between items-center py-4 border-b border-foreground/10"
                >
